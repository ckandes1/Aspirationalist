...
- The MQ Package remains the canonical Gartner MQ project at `docs/projects/mq-package/`.
- The consolidated source document is merged at `docs/projects/mq-package/source/2026-mq-season-notes.md`.
- The working decision document is merged at `docs/projects/mq-package/working/mq-package-decisions-v1.md`.
- Keith's review is required before approved MQ material moves into the canonical operating system.
- The NotebookLM project `"MQ Package" Content for Aspirationalist` is the pre-structure intake workspace for unstructured MQ assets.
- `docs/projects/mq-package/source/notebooklm-source-index.md` records the NotebookLM source categories, authority rule, and processing queue.
- GitHub becomes authoritative once NotebookLM material is processed into `source`, `working`, `canonical`, or `artifacts`.
...
- Which working MQ items are truly decided versus provisional?
- Is the MQ lifecycle correct enough to become the canonical spine?
- Which NotebookLM sources materially change the current MQ working decisions?
- What is the complete MQ demo workflow?
