...
- the canonical MQ operating model
- stage-by-stage playbooks
- checklists and action plans
- roles, ownership, and escalation guidance
- scripts and communications
...
1. Post-season
2. Year-round MQ management
3. Pre-season
4. Welcome Packet and MQ execution
5. Questionnaire and demo
...
- candid dictation and conversation from the 2026 cycle
- April 2026 MQ planning notes
- current-cycle retrospective
- gated workflow draft
- desk stickies and loose notes
...
- **Source:** notes, evidence, examples, transcripts, decks, and raw experience
- **Working:** synthesis, decisions, unresolved questions, and draft structure
- **Canonical:** the current authoritative MQ method and operating system
- **Artifact:** a polished output intended for someone else to use

Only create folders and files when the work is ready for them.
